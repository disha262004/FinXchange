...
function Hero() {
    return ( 
        <div className='container p-5'>
            <div className='row'>
                <h1 className='text-center fs-3 p-5'>We pioneered the discount broking model in India.<br/>Now, we are breaking ground with our technology.</h1>
            </div>
            <div className='row p-5 mt-5 border-top text-muted fs-6' style={{lineHeight:"1.8", fontSize:"1.2em"}}>
                <div className='col p-5'>
                    <p>We kick-started operations on the 15th of August, 2010 with the goal of breaking all barriers that traders and investors face in India in terms of cost, support, and technology. We named the company FinXchange, a combination of Zero and "Rodha", the Sanskrit word for barrier.</p>
